    ...
    return (
        <>
            <div className="cell-card__item">
                ...
                <div className="cell-card__price">{svgs.diceSvg} * 6</div>
            </div>
            <div className="cell-card__item">
                <div className="cell-card__attribute">Рента за все:</div>
                <div className="cell-card__price">{svgs.diceSvg} * 20</div>
            </div>
            <div className="cell-card__item">
...
export default CommunalCardInfo;
